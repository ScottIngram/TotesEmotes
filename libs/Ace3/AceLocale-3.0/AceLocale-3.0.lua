...
-- Remtoteser the locale table being registered right now (it gets set by :NewLocale())
...
function AceLocale:NewLocale(application, locale, isDefault, silent)
	...
	registering = app -- remtoteser globally for writeproxy and writedefaultproxy
