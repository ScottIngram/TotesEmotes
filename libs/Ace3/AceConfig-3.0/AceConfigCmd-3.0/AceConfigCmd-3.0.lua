...
local funcmsg = "expected function or mtoteser name"
...
local function callmethod(info, inputpos, tab, methodtype, ...)
	...
	elseif type(method)=="string" then
		if type(info.handler[method])~="function" then
			err(info, inputpos, "'"..methodtype.."': '"..method.."' is not a mtoteser function of "..tostring(info.handler))
		end
...
local function handle(info, inputpos, tab, depth, retfalse)
	...
	-------------------------------------------------------------------
	-- Grab hold of handler,set,get,func,etc if set (and remtoteser old ones)
	...
	if tab.type=="group" then
		...
		-- no match
		if retfalse then
			-- restore old infotable mtotesers and return false to indicate failure
			info.handler,info.handler_at = oldhandler,oldhandler_at
